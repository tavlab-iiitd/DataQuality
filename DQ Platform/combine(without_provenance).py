...
# fig = plt.subplots()
	...
	dq = (0.1582 * 100) + (0.158 * 100) + (0.1082 * metadataCoupling) + (0.1024 * NonDuplicatedRows) + (0.1175 * NonMissingCells) + (0.1493 * UnSkewness) + (0.1085 * CategoricalRatio) + (0.0979 * Uncorrelation)
